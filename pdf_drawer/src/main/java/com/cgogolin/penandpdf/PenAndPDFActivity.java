...
public static boolean isMediaDocument(Uri uri) {
    ...
    public void setupDocView() { //Is called during onResume()
        ...
        if(mDocView == null)
        {
            ...
            if(getSupportActionBar().isShowing() && getTheme().resolveAttribute(R.attr.actionBarSize, tv, true)) {
	...
	private void showDashboard() {
        ...
        //Animator scrollUp = ObjectAnimator.ofPropertyValuesHolder(null, PropertyValuesHolder.ofFloat("translationY", entryScreenScrollView.getHeight(), 0));
        //scrollUp.setInterpolator(new AccelerateDecelerateInterpolator());
        //Animator scrollDown = ObjectAnimator.ofPropertyValuesHolder(null, PropertyValuesHolder.ofFloat("translationY", 0, entryScreenScrollView.getHeight()));
     ...
     //   entryScreenLayout.setLayoutTransition(layoutTransition);
        ...
        fixedcard = (CardView)getLayoutInflater().inflate(R.layout.dashboard_card, entryScreenLayout, false);
        icon = fixedcard.findViewById(R.id.image);
        title = fixedcard.findViewById(R.id.title);
        subtitle = (TextView)fixedcard.findViewById(R.id.subtitle);
        ...
        for(final RecentFile recentFile: recentFilesList) {
            ...
            card.setOnClickListener((OnClickListener) view -> checkSaveThenCall(new Callable<Void>(){
                    public Void call() {
